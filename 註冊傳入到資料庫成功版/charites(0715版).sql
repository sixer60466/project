...
INSERT INTO `userinfo` (`uid`, `gender`, `cname`, `pwd`, `email`, `phone`, `address`, `token`) VALUES
('A01', 1, '王大明', '1234', 'wangdaming01@example.com', '1111', '台北市中山路一段一號', ''),
('A02', 0, 'Amy', '4567', 'amy002@example.com', '2222', '台中市一中街2號', ''),
('A09', 1, '王明', 'z1234567', 'qiq-jbhi@gmail.w', '0988999666', NULL, ''),
('Z01', 0, 'David', 'z12345678', 'qiq-jbhi@gmail.w', '0911222345', NULL, '');
